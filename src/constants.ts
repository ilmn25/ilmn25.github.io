...
export const PROJECTS: Project[] = [
  {
    ...
    category: "ai",
    tags: ["AI Agent", "MCP", "LLM", "RAG", "Vector DB"],
    highlights: [
  ...
  },
  {
    ...
    title: "3D Unity Game",
    description:
      "A work-in-progress survival game project built during my summer breaks.",
    category: "game",
    tags: ["Unity", "C#"],
    highlights: [
  ...
  },
  {
    ...
    description:
      "A cloud-native web app to streamline posting messages across many channels on Discord.",
    category: "web",
    tags: [
      "FastAPI",
      "React",
...
export const EXPERIENCES: Experience[] = [
  {
    ...
    description: [
      ...
      "Handled system and promotional materials design (posters and website), through direct collaboration with staff and owner to match their workflow and vision.",
